...
let order = prompt("Введите количество");
orderResult = Number(order);
if (orderResult === 0) {
    console.log("Отменено пользователем!");
} else {
    let totalPrice = orderResult * pricePerDroid;
    if (totalPrice > credits) {
    console.log("Недостаточно средств на счету!");
    } else {
        let balance = credits - totalPrice;
        console.log(`Вы купили ${order} дроидов, на счету осталось ${balance} кредитов.`);
}
}
